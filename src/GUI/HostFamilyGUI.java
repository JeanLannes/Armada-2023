...
public class HostFamilyGUI extends JPanel {
			...
			public void actionPerformed(ActionEvent e) {
				if (EditParticipant.getIndex()==4 || EditParticipant.getIndex()==3) {	// CONSULTATION
					...
					if (verify()) {	//ASSURE QUE TOUS LES CHAMPS SONT OCCUPES
			            ...
			            JOptionPane.showMessageDialog(btnAdd, "SUCCES : Le compte a ÈtÈ modifiÈ.");
	...
	/**
	 * Permet de d√©bloquer les champs de texte
	 */
	...
	/**
	 * Permet de mettre √† jour la page Commer√ßant avec les informations import√©s 
	 * @param Participant
	 */
