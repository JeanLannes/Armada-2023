...
public class Commercant extends JPanel {
	...
	public Commercant() {
		...
		JLabel lblActivity = new JLabel("ACTIVITE :");	//AJOUT DU TEXTE MDP
		...
		textField_1.setBounds(366, 366, 500, 50);
		add(textField_1);
		
		JLabel lblImmatriculation = new JLabel("STAND :");
		lblImmatriculation.setFont(new Font("Trebuchet MS", Font.PLAIN, 32));
		lblImmatriculation.setBounds(200, 361, 156, 67);
